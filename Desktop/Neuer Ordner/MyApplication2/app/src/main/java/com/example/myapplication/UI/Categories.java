...
public class Categories extends AppCompatActivity implements CategoriesDialog.CategoriesDialogListner{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myAdapter = new CategoriesAdapter(this, categoriesArrayList);
