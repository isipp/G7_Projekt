...
//TODO
        ...
        transaction_from = view.findViewById(R.id.enter_from);
        amount_transactions= view.findViewById(R.id.enter_amount_trans);
        type_trans= view.findViewById(R.id.type_trans);
        categories_transaction=view.findViewById(R.id.categories_transaction);
    ...
    public void onAttach(@NonNull Context context) {
        ...
        try {
            ...
            throw new ClassCastException(context.toString() + "TransactionsDialog");
        }

    }
    //What to do with text, that you entered in Dialog Window. applyTexts fuction is in "Transactions"
