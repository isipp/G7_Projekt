...
public class Transactions extends AppCompatActivity implements TransactionsDialog.TransactionsDialogListner, RecyclerViewInterface {
    ...
    @Override
    public void applyTexts_trans(String from, int amount, String type, String categories) {
        Context con = this;
        new TransactionHelper(con).addTrans(from, amount, type, categories, taList);
    }
